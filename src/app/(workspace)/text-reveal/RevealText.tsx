    ...
    () => {
      if (textRef.current) {
        ...
        const splitText = new SplitType(textRef.current, {
          ...
          lineClass:
            "line relative before:contents-[''] before:block before:h-full before:w-(--width) before:bg-zinc-950 before:absolute before:top-0 before:left-(--left) before:right-(--right) p-1",
        });
