...
export default function Page() {
	const titleRevealTextReference = useRef<GSAPTimeline>();
	const paragraphRevealTextReference = useRef<GSAPTimeline>();
		...
		<main>
			...
			<section className="w-full h-svh flex flex-col justify-end items-center px-12 py-4 gap-2">
				...
				<div className="flex justify-between items-center w-full font-poppins text-sm">
					<RevealText element="p" timelineRef={addStoreRevealTextReference}>
						AIGO ltd.
					</RevealText>
					<RevealText element="p" timelineRef={addStoreRevealTextReference}>
						RENEWALE .co
